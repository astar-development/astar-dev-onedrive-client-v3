...
public class AccountManagementIntegrationShould : IDisposable
{
    ...
    {
        var account1 = new AccountInfo("acc1", "User One", "/path1", true, null, null, false, false, 3, 50);
        var account2 = new AccountInfo("acc2", "User Two", "/path2", false, null, null, false, false, 3, 50);
    ...
    {
        var account = new AccountInfo("acc-to-delete", "User", "/path", true, null, null, false, false, 3, 50);
    ...
    {
        var account = new AccountInfo("acc-login", "User", "/path", false, null, null, false, false, 3, 50);
        await _accountRepository.AddAsync(account);
    ...
    {
        var account = new AccountInfo("acc-logout", "User", "/path", true, null, null, false, false, 3, 50);
        await _accountRepository.AddAsync(account);
